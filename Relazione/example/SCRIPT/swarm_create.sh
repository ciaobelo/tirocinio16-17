...
#
# Questo script iniltre un volta lanciato crea automaticamente altri due script che permettono se eseguiti su una macchina 
# adibita a far parte di un gruppo di macchine ad aggiungerla allo sciame o come manager secondario o come primario.
#
